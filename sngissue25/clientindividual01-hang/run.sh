...
STOMP_DRAIN=yes STOMP_NMSGS=$ncms STOMP_VHOST=$vh STOMP_PORT=$port STOMP_PROTOCOL=$proto STOMP_DEST=/queue/clientindividual01-hang.1 go run clientindividual01-hang.go
set +x
