...
func main() {
	...
	if e != nil {
		log.Fatalln("dial:", e) // Handle this ......
	}
	// Stomp connect, 1.1
	...
	if e != nil {
		log.Println("disconnect:", e) // Handle this ......
	}
	// Network close
	e = n.Close()
	if e != nil {
		log.Println("netclose:", e) // Handle this ......
	}
